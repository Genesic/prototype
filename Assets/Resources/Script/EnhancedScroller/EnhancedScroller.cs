...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public class EnhancedScroller : MonoBehaviour
    {
		...
		protected float _contentOffset = 0.0f;
        ...
        /// </summary>
        protected SmallList<float> _cellViewOffsetArray = new SmallList<float>();
        ...
        /// </summary>
        protected SmallList<EnhancedScrollerCellView> _activeCellViews = new SmallList<EnhancedScrollerCellView>();
